...
('prod_019', 'Fleece Pullover Hoodie', 'Hoodie', 369000, 'assets/images/prod_019.png', 38, 4.7, 'Pullover hoodie dengan bahan fleece premium yang sangat lembut. Desain minimalis yang cocok untuk berbagai gaya.', true, '["fleece", "pullover", "minimalist", "soft", "premium"]', '2025-03-01 08:00:00'),
('prod_020', 'Slim Straight Jeans', 'Pants', 449000, 'assets/images/prod_020.png', 42, 4.8, 'Jeans slim straight dengan bahan denim premium yang nyaman dan tahan lama.', true, '["jeans", "denim", "slim-straight", "premium", "everyday"]', '2025-03-05 08:00:00'),
('prod_021', 'Puffer Jacket Winter', 'Jacket', 699000, 'assets/images/prod_021.png', 20, 4.9, 'Puffer jacket dengan insulasi premium yang sangat hangat. Desain modern yang stylish.', true, '["puffer", "winter", "warm", "insulated", "premium"]', '2025-03-10 08:00:00'),
('prod_022', 'Henley Shirt', 'T-Shirt', 219000, 'assets/images/prod_022.png', 65, 4.5, 'Henley shirt dengan detail kancing di bagian leher. Bahan cotton waffle yang unik dan nyaman.', false, '["henley", "waffle", "casual", "button", "cotton"]', '2025-03-15 08:00:00')
