...
export function initCheckoutPage() {
  ...
  form?.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      Toast.show('Pesanan berhasil! Mengarahkan ke WhatsApp...', 'success');
      
      if (result.whatsapp_url) {
        setTimeout(() => { window.location.href = result.whatsapp_url; }, 1500);
      } else {
      ...
      console.error(error);
      Toast.show('Terjadi kesalahan saat memproses checkout.', 'error');
    }
  });
}
